...
```{r elicitacion}
limits <- c(min(tasas_mort$value),max(tasas_mort$value))
...
gamma.inicial<-map_dbl(1:1000,rgamma(initial_guess[1],initial_guess[1]))
gamma.final<-map_dbl(rgamma(params.prior[1],params.prior[1]),1:1000)
